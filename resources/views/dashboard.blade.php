                                        ...
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-6.jpg') }}"
                                                    title="Uploaded at 4 May 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-9.jpg') }}"
                                                    title="Uploaded at 21 February 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-11.jpg') }}"
                                                    title="Uploaded at 16 June 2020">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-14.jpg') }}"
                                                    title="Uploaded at 1 April 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-3.jpg') }}"
                                                    title="Uploaded at 15 September 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-2.jpg') }}"
                                                    title="Uploaded at 30 November 2021">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-9.jpg') }}"
                                                    title="Uploaded at 16 March 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-14.jpg') }}"
                                                    title="Uploaded at 1 August 2021">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-1.jpg') }}"
                                                    title="Uploaded at 2 March 2022">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                <tr class="intro-x">
                                    <td class="w-40">
                                        <div class="flex">
                                            <div class="w-10 h-10 image-fit zoom-in">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-4.jpg') }}"
                                                    title="Uploaded at 16 November 2020">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-10.jpg') }}"
                                                    title="Uploaded at 11 November 2022">
                                            </div>
                                            <div class="w-10 h-10 image-fit zoom-in -ml-5">
                                                <img alt="Midone - HTML Admin Template" class="tooltip rounded-full"
                                                    src="{{ asset('image/preview-9.jpg') }}"
                                                    title="Uploaded at 12 April 2022">
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                        ...
                        <div
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                <div
                                    ...
                                    <div class="w-10 h-10 flex-none image-fit rounded-full overflow-hidden">
                                        <img alt="Midone - HTML Admin Template"
                                            src="{{ asset('image/profile-10.jpg') }}">
                                    </div>
                                </div>
                                        ...
                                        <div class="flex mt-2">
                                            <div class="tooltip w-8 h-8 image-fit mr-1 zoom-in" title="Dell XPS 13">
                                                <img alt="Midone - HTML Admin Template"
                                                    ...
                                                    src="{{ asset('image/preview-15.jpg') }}">
                                            </div>
                            ...
                            <div class="intro-x relative flex items-center mb-3">
                                ...
                                <div class="box px-5 py-3 ml-4 flex-1 zoom-in">
                                    ...
                                    <div class="text-slate-500 mt-1">Has changed <a class="text-primary" href="">Dell
                                            XPS 13</a> price and description</div>
                                </div>
                            </div>
                            <div class="intro-x relative flex items-center mb-3">
                                <div
