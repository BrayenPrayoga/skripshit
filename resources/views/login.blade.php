            ...
            <div class="hidden xl:flex flex-col min-h-screen">
                ...
                <div class="my-auto">
                    <img alt="Midone - HTML Admin Template" class="-intro-x w-1/2 -mt-16"
                        src="{{ asset('image/illustration.svg') }}">
                ...
                <div
                    ...
                    <form method="POST" action="{{ route('login.action') }}">
                        ...
                        <div class="intro-x mt-8">
                            <input type="text" class="intro-x login__input form-control py-3 px-4 block" name="email" placeholder="Email" required>
                        ...
                        <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                            ...
                            <a href="{{ route('register.action') }}" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Register</a>
                        </div>
                    </form>
                </div>
            </div>
