...
<html lang="en" dir="ltr">
    ...
    <body>
        ...
        <div class="content" style="text-align:center;">
            <span style="font-size: 3em;font-weight: bold;">Hello? Is somebody there?</span><br>
            <span style="font-size: 1em;">
                We know it’s scary, but the page you’re trying to reach can’t be found. Perhaps it was just a bad link dream?
            </span><br>
            <a href="{{ route('dashboard.index') }}" class="btn btn-sm btn-light">BACK</a>
        </div>
    </body>
    <script>
        var 
